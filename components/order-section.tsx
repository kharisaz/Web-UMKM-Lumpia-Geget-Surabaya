...
import { MessageCircle, ExternalLink, ShoppingCart } from "lucide-react"
import { WHATSAPP_INFO_LINK, GRABFOOD_LINK } from "@/lib/site-data"
      ...
      <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
        <Reveal className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-pretty text-base leading-relaxed text-muted-foreground">
            Pesan langsung via WhatsApp dengan pilih menu dari keranjang, atau gunakan GrabFood untuk kemudahan pembayaran dan pengantaran.
          </p>
        </Reveal>
            ...
            <div className="group relative flex h-full flex-col overflow-hidden rounded-3xl border-2 border-[#25D366]/20 bg-card p-8 transition-all duration-300 hover:-translate-y-1 hover:border-[#25D366]/50 hover:shadow-xl hover:shadow-[#25D366]/5">
              ...
              <div className="relative">
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  Pilih menu dari keranjang dan detail pesananmu terkirim otomatis ke WhatsApp kami — atau chat langsung untuk tanya-tanya dulu.
                </p>
                <ul className="mt-5 space-y-2.5">
                  <li className="flex items-center gap-2 text-sm text-muted-foreground">
                    <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#25D366]/10 text-[#25D366]">✓</span>
                    Pilih banyak menu sekaligus
                  </li>
                  <li className="flex items-center gap-2 text-sm text-muted-foreground">
                    <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#25D366]/10 text-[#25D366]">✓</span>
                    Kalkulator total otomatis
                  </li>
                  <li className="flex items-center gap-2 text-sm text-muted-foreground">
                    <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#25D366]/10 text-[#25D366]">✓</span>
